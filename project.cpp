...
void character1() {
    ...
    if (cin.eof()) {
        cout << "Invalid input:Please enter number between 0 to 5 ";
    }
...
int main() {
    ...
    while (option != 6) {
        ...
        cout << "Enter a number to play any mission (1-6) ";
        cin >> option;
